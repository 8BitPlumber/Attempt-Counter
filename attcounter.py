...
class AttemptCounter:
    ...
    def update_hotkeys(self):
        ...
        if hasattr(self, 'reset_key_id'):
            keyboard.remove_hotkey(self.reset_key_id)
        
        # Set new hotkeys
        self.hotkey_id = keyboard.add_hotkey(self.hotkey, self.increment_attempts)
        self.reset_key_id = keyboard.add_hotkey(self.reset_key, self.reset_attempts)
